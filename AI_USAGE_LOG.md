# Log Penggunaan Kecerdasan Buatan (AI)

| Tujuan Penggunaan AI | Prompt Ringkas | Hasil | Verifikasi | Keputusan Mahasiswa |
| :--- | :--- | :--- | :--- | :--- |
| Memahami instruksi modul praktikum | Meminta ringkasan langkah kerja dari lampiran gambar instruksi | Pemaparan ringkas mengenai 10 langkah pengerjaan praktikum | Analisis sesuai dengan isi dokumen asli | Diterima sebagai acuan langkah kerja |
| Mengatasi galat kompatibilitas PHP 8.4 pada Laragon | Melampirkan tangkapan layar galat terminal saat mengeksekusi PHP | Identifikasi galat `VCRUNTIME140.dll` beserta instruksi pembaruan pustaka Visual C++ | Pesan galat pada sistem relevan dengan analisis | Diterima dan diterapkan |
